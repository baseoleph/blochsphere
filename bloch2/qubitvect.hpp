...
// --------------------------------
{
    QUOperator(comp_d a_ = 1.0, comp_d b_ = 0.0, comp_d c_ = 0.0, comp_d d_ = 1.0);
    void   set(comp_d a_ = 1.0, comp_d b_ = 0.0, comp_d c_ = 0.0, comp_d d_ = 1.0);
    double _alp() const {
        return alpha;
    }
    double _bet() const {
    ...
    QUOperator        operator*(comp_d n) const;
...
//          Основные операторы
// -------------------------------------
const QUOperator Hop(1.0 / sqrt(2.0), 1.0 / sqrt(2.0), 1.0 / sqrt(2.0), -1.0 / sqrt(2.0));
...
const QUOperator Top(1.0, 0.0, 0.0,
                     pow(comp_d(EEE, 0.0),
                         comp_d(0.0, 1.0) * comp_d(M_PI, 0.0) / comp_d(4.0, 0.0)));
const QUOperator Iop(1.0, 0.0, 0.0, 1.0);
// QUOperator Hop(1.0 / sqrt(2.0), 1.0 / sqrt(2.0), 1.0 / sqrt(2.0), -1.0 / sqrt(2.0));
// QUOperator Xop(0.0, 1.0, 1.0, 0.0);
// QUOperator Yop(0.0, -C_I, C_I, 0.0);
// QUOperator Zop(1.0, 0.0, 0.0, -1.0);
// QUOperator Sop(1.0, 0.0, 0.0, C_I);
// QUOperator Top(1.0, 0.0, 0.0,
//               pow(comp_d(EEE, 0.0), comp_d(0.0, 1.0) * comp_d(M_PI, 0.0) / comp_d(4.0, 0.0)));
// QUOperator Iop(1.0, 0.0, 0.0, 1.0);
